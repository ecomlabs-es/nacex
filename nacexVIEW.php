...
class nacexVIEW
{
    ...
    public static function showExpedicionBoxInfo($datosexpedicion, $id_pedido, $solicitud, $ver177 = false)
    {
        ...
        if (isset($estado_exp) && (in_array($estado_exp, $estadosCancelables) || strpos($estado_exp, 'PENDIENTE') === 0)) {
            ...
            $html .= '<button type="button" class="zoomable" style="background:none;border:1px solid #333;border-radius:50%;cursor:pointer;vertical-align:top;padding:6px;width:38px;height:38px;display:inline-flex;align-items:center;justify-content:center;" onclick="nacexEditExpedicion(\'' . $expId . '\');" title="' . $nacex->l('Edit expedition') . '">
